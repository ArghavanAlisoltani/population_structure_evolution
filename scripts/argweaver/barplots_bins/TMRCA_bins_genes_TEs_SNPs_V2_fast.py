#!/usr/bin/env python3
"""
TMRCA_bins_genes_TEs_SNPs_V2_fast.py

Faster version using vectorized per-scaffold operations.
...
def main():
    p = argparse.ArgumentParser(
        description=(
            "FAST: Compute average TMRCA per gene and TE, then bin TMRCA values and "
    ...
    # output
    p.add_argument("--outdir", default="tmrca_bins_out_v2_fast",
    ...
    m_id    = pick_col(mcols, [args.mrna-id-col] if False else [args.mrna_id_col], label="mRNA ID")  # safe hack
